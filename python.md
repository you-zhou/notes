...
The output below would be directories where Python would look for modules.

```Windows
C:\Users\CP528171\Dev\GitHub
C:\Users\CP528171\AppData\Roaming\Python\Python39\site-packages
...
1. str.format() from Python 2.6 (much improved from the % operator) [Python docs](https://docs.python.org/3/library/stdtypes.html#str.format)
