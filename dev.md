...
3. create a virtual environment for the project
	* virtualenvwrapper
	...
	or
	* pipenv
	`$ cd ~/Dev/bitsroom` # **NOTE** enter for project folder first
	`$ pipenv install` # create/prepare a virtual environment
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5Mzc2MDY5NjksLTE5NDU1NzI0OThdfQ
==
-->