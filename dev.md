...
```
You can start Python by setting the PYTHONPATH to a directory, it indicates to Python where to look for libraries:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUwMzMwNzMzNiw0MTMzNzExOTAsLTU4Nj
