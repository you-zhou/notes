...
`$ psql -U postgres -W`
If there is an error message: `psql: FATAL: Peer authentication failed for user "postgres"`, edit `/etc/postgresql/9.6/main/pg_hba.conf`
```sql
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTAxMTEzNjMsLTIwMzE4NzI1OTksLT
E5NDU1NzI0OThdfQ==
-->